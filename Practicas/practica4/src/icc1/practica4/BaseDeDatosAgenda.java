...
/** Método que busca un nombre en la lista y lo regresa, si es que existe.
  * @param el nombre que se desea encontrar.
  * @return el nombre de la lista, sino existe dice "Null".
  */
...
/** Método que busca un número en la lista y lo regresa, si es que existe.
  * @param el número del teléfono que se desea encontrar.
  * @return el teléfono de la lista, sino existe dice "Null".
  */
